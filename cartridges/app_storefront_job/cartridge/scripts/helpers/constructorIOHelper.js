...
function getConstructorIOSettings(pdict) {
    ...
    var settings = {
        ...
        search_enabled: ('Constructor_Search_Enabled' in Site.current.preferences.custom && Site.current.getCustomPreferenceValue('Constructor_Search_Enabled')) || false,
        ...
        customerEmail: currentCustomer && currentCustomer.profile ? sha256(currentCustomer.profile.email) : '',
